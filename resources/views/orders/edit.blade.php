            ...
            <div class="row my-4">
                <div class="col-md-4">
                    <div class="alert alert-info w-75 mx-auto" role="alert">
                        <p class="text-center mb-0">
                            @lang('Total'): {{$cartOrder->formattedTotal}}
                        </p>
                    </div>
                    <div class="w-100 mx-auto my-3">
                        <form class="center-col" action="{{route('orders.update', $order)}}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="row mt-3">
                                <div class="col">
                            ...
                            <div class="d-flex justify-content-center">
                                <button class="btn btn-success"
                                        type="submit">@lang('Confirm order')</button>
                                <a href="{{route('orders.index')}}"
                                   class="btn btn-danger ml-2">@lang('Cancel')</a>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-md-8">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        @foreach ($cartOrder->products as $product)
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">{{$product->formattedTotal}}
                                </td>
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <form action="{{route('products.carts.orders.addOne', $product)}}" method="POST">
                                            @csrf
                                        ...
                                        <form action="{{route('products.carts.orders.removeOne', [$product, $cartOrder])}}"
                                              method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <button class="btn btn-outline-dark" type="submit">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                     fill="currentColor" class="bi bi-dash-circle-dotted" viewBox="0 0 16 16">
                                                    <path
