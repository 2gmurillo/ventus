        ...
        @if (!isset($cart) || $cart->products->isEmpty())
            <div class="alert alert-info w-25 mx-auto mt-3" role="alert">
                <p class="text-center mb-0">
                    @lang('There are no products in the cart')
                </p>
            </div>
        @else
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <div class="d-flex justify-content-center">
                                ...
                                <form action="{{route('products.carts.addProductToCart', $product)}}" method="POST">
                                    @csrf
                                ...
                                <form action="{{route('products.carts.removeProductFromCart', [$product, $cart])}}"
                                      method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <button class="btn btn-outline-dark" type="submit">
